...
import nel from "../images/token/nearlend.png";
import near from "../images/token/near.png";
import btc from "../images/token/bitcoin.png";
import doge from "../images/token/doge.png";
import shib from "../images/token/shiba.png";
import sol from "../images/token/solana.png";
import usdt from "../images/token/usdt.png";
import weth from "../images/token/weth.png";

export const tokenFomat: any = {
  "aurorax.testnet": {
    nameUsd: 'aurora',
    name: "aurora",
    symbol: "Aurora",
